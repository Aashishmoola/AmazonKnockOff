...
async function setAllDataToLS() { 
  ...
  function setAllProductCategories(allProductData: ProductDataType[]){
    ...
    allProductData.forEach((productData) => productCategories.add(productData.category)) 
    localStorage.setItem("allProductCategories", JSON.stringify([...productCategories]))
  }
